 ...
 */
	Configure::write('Security.salt', 'DYhNAG93b0qyJRUfIxfLALs2guVoUubWwvniR2GKEER0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76892525930965745354249674961538383645');
