...
<?php echo $this->Html->script(array('jquery-ui-timepicker-addon','CarRental')); ?>
<div class="reservation-from">
    ...
    <div class="field clearfix fr">
        ...
        <?php echo $this->Form->input('service_end_date', array('id' => 'service_end_date', 'placeholder' => 'Eg. 15-Aug-2014', 'label' => false, 'div' => false, 'class' => 'end_date_time_taxi_picker validate[required]')); ?>
    </div>
...
echo $this->Html->script(array('/timepicker/jquery.timepicker', 'jquery.validationEngine', 'jquery.validationEngine-en'));
?>
<script>
    $(function () {
