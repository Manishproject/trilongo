...
<div class="reservation-from">
    ...
    <div class="form-heading"><h2>Vehicle Type</h2></div>
    <div class="field clearfix fl">
        <label class="label">Choose Vehicle Type<b class="red_star">*</b></label>
        <?php echo $this->Form->input('vehicle_id', array( 'options'=>$vehicle_type,'empty'=>'Select Vehicle ','label' => false, 'div' => false, 'class' => 'validate[required]')); ?>
    </div>
