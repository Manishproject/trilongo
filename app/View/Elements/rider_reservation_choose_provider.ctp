<div class="content_row choose_provider ">
    <?php
    // get service type
    $service_type = "";
    ...
    <div class="action_bar"><a  href="<?php echo SITE_URL . "riders/reservation_info_choose_provider/" . $reservation_data['Reservation']['id'];; ?>">Show more info</a></a> </div>
    <div class="clear"></div>
</div>