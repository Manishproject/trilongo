            ...
            <div class="well"><input type="text" id="kwd_search" value="" placeholder="Type here to search"/>
                ...
                <form id="mainform" method="post"
                    ...
                    <table class="table tablesorter" id="my-table">
                        ...
                        <tbody>
                        <?php if (!empty($trash_message)) {
                            foreach ($trash_message as $data) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a onclick="return confirm('Are you sure you want to parmanetely delete this thread ?')"
                                           href="<?php echo SITE_URL . 'admin/messages/delete/thread/' . $id . '/delete'; ?>"
                                           title="Delete" class="icon-remove"></a>
                                        | <a onclick="return confirm('Are you sure you want to restore this thread?')"
                                             href="<?php echo SITE_URL . 'admin/messages/delete/thread/' . $id . '/restore'; ?>"
                                             title="Delete" class="icon-restore">Restore</a>
