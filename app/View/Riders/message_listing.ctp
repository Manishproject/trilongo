            ...
            <div class="message_inbox">
                ...
                if (isset($message_all_data) && !empty($message_all_data)) {
                    foreach ($message_all_data as $key => $message_data) {
                        if ($message_data['MessageIndex']['message_type'] == 2) {
    ...
    (function ($) {
        JqueryReadMessage = {
            ...
            message_read_update_notification_div: function () {
                ...
                var counting_notification = $(".user_w_icon ul li").eq(1).find("b").text();
                ...
                if (remaining_notification == 0) {
                    ...
                    $(".user_w_icon ul li").eq(1).find("b").remove();
                    $(".user_w_icon ul li").eq(1).html(remaining_notification)
                } else {
                    $(".user_w_icon ul li").eq(1).find("b").text(remaining_notification)
                }
