    ...
    <div class="form_pages">
        <div class="login-pannel signup-pannel form_bg">
            ...
            <div class="field clearfix fr">
                ...
                <?php echo $this->Form->input('User.profile_pic', array('type' => 'file', 'class' => 'browse', 'label' => false));
                if (isset($provider_info['User']['profile_pic']) && !empty($provider_info['User']['profile_pic'])) {
                    $provider_profile_image = $this->Custom->check_image($provider_info['User']['profile_pic'], 'profile_photo');
                    echo $this->Image->resize('data/profile_photo/' . $provider_profile_image, 125, 125, true, false);
                }
                ?>
            </div>
            ...
            <div class="field clearfix ft">
                ...
                <?php echo $this->Form->input('phone', array( 'maxlength' => 15,'class' => 'textbox validate[required]', 'label' => false, 'placeholder' => 'Contact No.', 'div' => false,'id'=>'mobile-number')); ?>
            </div>
            <div class="field clearfix fr">
                <label class="label">Country Name <b class="red_star">*</b></label>
                <?php
                echo $this->Form->input('country_id', array('options' => $country_data, 'class' => 'selects country_select validate[required]', 'label' => false, 'div' => false));
            ...
            <div class="field clearfix fr">
                ...
                <?php echo $this->Form->input('zip', array('class' => 'onlyNumber textbox validate[required,custom[onlyNumberSp]]', 'type' => 'text', 'maxlength' => 6, 'label' => false, 'placeholder' => 'Zip Code', 'div' => false)); ?>
            </div>
            <div class="field clearfix ft about-pro">
                <label class="label">About Provider</label>
                <?php
                echo $this->Form->input('about', array('type' => 'textarea', 'class' => ' textarea', 'id' => 'chars', 'rows' => '3', 'placeholder' => "Jaipur, Rajasthan, IN 302021", 'label' => false, 'div' => false));
                ?>
            </div>
            <div class="clear"></div>
