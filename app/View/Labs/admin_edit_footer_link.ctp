...
<div class="row-fluid">
    <div class="span12">
        ...
        <h3 class="page-title">Edit Footer Link</h3>
...
<div class="tab-pane" id="tab_4">
    <div class="portlet box blue">
        <div class="portlet-title">
            <h4><i class="icon-reorder"></i> Edit Footer Link </h4>
        </div>
        <div class="portlet-body form">
            ...
            <div class="control-group">
                <label class="control-label">Select Footer Category</label>

                <div class="controls">
                    <?php echo $this->Form->input('footer_category_id', array('options' => $all_footer_cat, 'class' => 'm-wrap span12 footer_cat', 'label' => false)); ?>
                    <span class="help-inline">Select Footer Category</span>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    echo $this->Form->input('position', array('options' => $position_array, 'class' => 'm-wrap span12 position', 'label' => false));
                    ?>
...
<script>
    ...
    $(function () {
        $(".footer_cat").change(function () {

            var current_cat = $(this).val();
            $.post("<?php echo SITEURL . "admin/labs/get_cat_total_link" ?>", {current_cat: current_cat}, function (data) {
                data = $.parseJSON(data);
                $(".position").html('');
                $(".position").find('option').remove()
                $.each(data, function (key, index) {
                    $(".position").append('<option value="' + key + '">' + index + '</option>')
                })
