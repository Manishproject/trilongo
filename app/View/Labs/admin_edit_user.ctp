                    ...
                    <div class="tab-pane" id="tab_4">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <h4>
                                    <i class="icon-reorder"></i> Edit User
                                </h4>
                            </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        if (isset($this->request->data['User']['country_id']) && !empty($this->request->data['User']['country_id'])) {
                                            $state_list = $this->Lab->WorldData($this->request->data['User']['country_id']);
                                        }
                                        echo $this->Form->input('state_id', array('options' => $state_list, 'default' => $this->request->data['User']['state_id'], 'empty' => 'Select State', 'label' => false, 'class' => 'm-wrap span12 state_select', 'required' => false,));
