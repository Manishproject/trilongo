    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">All Footer Category
                    <small></small>
                </h3>
                ...
                <div class="portlet box light-grey">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="dataTables_filter" id="sample_1_filter">
                            <script>
                                ...
                                function change_status(id, type) {
                                    if (id != "") {
                                        var datastring = "F_id=" + id + "&type=" + type;
                                        $("#LabMsg").html('');

                                        $(function () {
                                            $.ajax({type: 'POST',
                                                url: '<?php echo SITEURL; ?>admin/labs/update_footer_cat/',
                                                data: datastring,
                                                success: function (data) {
                                                    $("#LabMsg").html(data);
                                                },
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <?php
                            if (!empty($footer_all_cat)) {
                                foreach ($footer_all_cat as $footer_cat) {
                                    ?>
                                    <tr class="odd gradeX">
                                        <td><?php echo $footer_cat['FooterCategory']['id']; ?></td>
                                        <td><?php echo ucfirst($footer_cat['FooterCategory']['category_name']); ?></td>
                                        <td class="hidden-480"
                                            id="<?php echo "st_" . $footer_cat['FooterCategory']['id']; ?>">
                                            <?php
                                            if ($footer_cat['FooterCategory']['status'] == 0) {
                                                echo "Deactivate";
                                            } elseif ($footer_cat['FooterCategory']['status'] == 1) {
                                                echo "Active";
                                            } else {
                                                echo "Not available";
                                            }
                                        ...
                                        <td class="hidden-480"><?php echo $this->Lab->ShowDate($footer_cat['FooterCategory']['created']); ?></td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><?php echo $this->Html->link('<i class="icon-plus"></i> Edit', array('controller' => 'labs', 'action' => 'edit_footer_cat/' . $footer_cat['FooterCategory']['id']), array('class' => '', 'escape' => false)); ?></li>
                                                    <li><?php echo $this->Html->link('<i class="icon-plus"></i> Add Page', array('controller' => 'labs', 'action' => 'add_footer_link/' . $footer_cat['FooterCategory']['id']), array('class' => '', 'escape' => false)); ?></li>
                                                    <?php if ($footer_cat['FooterCategory']['status'] == 2 || $footer_cat['FooterCategory']['status'] == 0) { ?>
                                                        <li id="<?php echo "sp_" . $footer_cat['FooterCategory']['id']; ?>">
                                                            <a href="javascript:void(0);"
                                                               onclick="change_status(<?php echo $footer_cat['FooterCategory']['id']; ?>, 1)"><i
                                                                    class="icon-remove"></i> <span>Active</span> </a>
                                                        </li>
                                                    <?php } elseif ($footer_cat['FooterCategory']['status'] == 1) { ?>
                                                        <li id="<?php echo "sp_" . $footer_cat['FooterCategory']['id']; ?>">
                                                            <a href="javascript:void(0);"
                                                               onclick="change_status(<?php echo $footer_cat['FooterCategory']['id']; ?>, 0)"><i
                                ...
                                ?>
                                <tr>
                                    <td colspan="12" class="mid"> No Category found</td>
                                </tr>
                            <?php } ?>
